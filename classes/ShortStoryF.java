...
public class ShortStoryF extends JFrame implements ActionListener
{
	private JFrame ShortStoryFrame;
	...
	public ShortStoryF(HomePage home,Login login)
	{
		ShortStoryFrame=new JFrame(" SHORTSTORY FRAME ");
	...
	//BackButton
		...
		B7.setCursor(cursor);
		ImageIcon icon17 = new ImageIcon("Images\\B24.JPG");
        B7.setIcon(icon17);
		...
		B8.setCursor(cursor);
		ImageIcon icon18 = new ImageIcon("Images\\B25.JPG");
        B8.setIcon(icon18);
		...
		B9.setCursor(cursor);
		ImageIcon icon19 = new ImageIcon("Images\\B26.JPG");
        B9.setIcon(icon19);
		...
		ImageIcon icon20 = new ImageIcon("Images\\B27.JPG");
        B10.setIcon(icon20);
		...
		for(int i=0; i<home.info.length && i<4; i++)
				{
					...
					if(home.info[i]!=null)
					{
						...
						else if(sp[1].equals("25"))
						 {
						    l5.setText(sp[0]);
							l7.setText("BDT "+sp[2]+"tk");
							
						 }
						 else if(sp[1].equals("26"))
						 {
						    l6.setText(sp[0]);
							l8.setText("BDT "+sp[2]+"tk");
							
						 }
						  else if(sp[1].equals("27"))
						 {
						    l1.setText(sp[0]);
	...
	ShortStoryFrame.add(p1);
		...
		//ShortStoryFrame Properties
	     ShortStoryFrame.setSize(1080, 650);
        ShortStoryFrame.setLayout(null);
         ShortStoryFrame.setLocationRelativeTo(null);
         ShortStoryFrame.setVisible(true);
		 ShortStoryFrame.setResizable(false);
         ShortStoryFrame.setDefaultCloseOperation(EXIT_ON_CLOSE);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
         ShortStoryFrame.setVisible(false);
		 new HomePage(login);
		}
		if(e.getSource()==B7)
		{ 
