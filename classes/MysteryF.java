...
public class MysteryF extends JFrame implements ActionListener
{
	private JFrame MysteryFrame;
	...
	public MysteryF(HomePage home,Login login)
	{
		MysteryFrame=new JFrame(" MYSTERY FRAME ");
	...
	//BackButton
		...
		B7.setCursor(cursor);
		ImageIcon icon17 = new ImageIcon("Images\\B32.JPG");
        B7.setIcon(icon17);
		...
		B8.setCursor(cursor);
		ImageIcon icon18 = new ImageIcon("Images\\B33.JPG");
        B8.setIcon(icon18);
		...
		B9.setCursor(cursor);
		ImageIcon icon19 = new ImageIcon("Images\\B35.JPG");
        B9.setIcon(icon19);
		...
		ImageIcon icon20 = new ImageIcon("Images\\B18.JPG");
        B10.setIcon(icon20);
		...
		for(int i=0; i<home.info.length && i<4; i++)
				{
					...
					if(home.info[i]!=null)
					{
						...
						else if(sp[1].equals("33"))
						 {
						    l5.setText(sp[0]);
							l7.setText("BDT "+sp[2]+"tk");
							
						 }
						 else if(sp[1].equals("34"))
						 {
						    l6.setText(sp[0]);
							l8.setText("BDT "+sp[2]+"tk");
							
						 }
						  else if(sp[1].equals("35"))
						 {
						    l1.setText(sp[0]);
	...
	MysteryFrame.add(p1);
		...
		//MysteryFrame Properties
	     MysteryFrame.setSize(1080, 650);
         MysteryFrame.setLayout(null);
         MysteryFrame.setLocationRelativeTo(null);
         MysteryFrame.setVisible(true);
		 MysteryFrame.setResizable(false);
         MysteryFrame.setDefaultCloseOperation(EXIT_ON_CLOSE);
