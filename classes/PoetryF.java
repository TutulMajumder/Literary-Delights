...
public class PoetryF extends JFrame implements ActionListener
{
	private JFrame PoetryFrame;
	...
	public PoetryF(HomePage home,Login login)
	{
		PoetryFrame=new JFrame(" POETRY FRAME ");
	...
	//BackButton
		...
		B7.setCursor(cursor);
		ImageIcon icon17 = new ImageIcon("Images\\B19.JPG");
        B7.setIcon(icon17);
		...
		B8.setCursor(cursor);
		ImageIcon icon18 = new ImageIcon("Images\\B20.JPG");
        B8.setIcon(icon18);
		...
		B9.setCursor(cursor);
		ImageIcon icon19 = new ImageIcon("Images\\B21.JPG");
        B9.setIcon(icon19);
		...
		ImageIcon icon20 = new ImageIcon("Images\\B3.JPG");
        B10.setIcon(icon20);
		...
		for(int i=0; i<home.info.length && i<4; i++)
				{
					...
					if(home.info[i]!=null)
					{
						 ...
						 else if(sp[1].equals("21"))
						 {
						    l6.setText(sp[0]);
							l8.setText("BDT "+sp[2]+"tk");
							
						 }
						  else if(sp[1].equals("22"))
						 {
						    l1.setText(sp[0]);
	...
	PoetryFrame.add(p1);
		...
		//UponashFrame Properties
	     PoetryFrame.setSize(1080, 650);
         PoetryFrame.setLayout(null);
         PoetryFrame.setLocationRelativeTo(null);
         PoetryFrame.setVisible(true);
		 PoetryFrame.setResizable(false);
         PoetryFrame.setDefaultCloseOperation(EXIT_ON_CLOSE);
