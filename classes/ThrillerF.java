...
public class ThrillerF extends JFrame implements ActionListener
{
	private JFrame ThrillerFrame;
	...
	public ThrillerF(HomePage home,Login login)
	{
	ThrillerFrame=new JFrame(" THRILLER FRAME ");
	...
	//BackButton
		...
		B7.setCursor(cursor);
		ImageIcon icon17 = new ImageIcon("Images\\B28.JPG");
        B7.setIcon(icon17);
		...
		B8.setCursor(cursor);
		ImageIcon icon18 = new ImageIcon("Images\\B29.JPG");
        B8.setIcon(icon18);
		...
		B9.setCursor(cursor);
		ImageIcon icon19 = new ImageIcon("Images\\B30.JPG");
        B9.setIcon(icon19);
		...
		ImageIcon icon20 = new ImageIcon("Images\\B31.JPG");
        B10.setIcon(icon20);
		...
		for(int i=0; i<home.info.length && i<4; i++)
				{
					...
					if(home.info[i]!=null)
					{
						...
						else if(sp[1].equals("29"))
						 {
						    l5.setText(sp[0]);
							l7.setText("BDT "+sp[2]+"tk");
							
						 }
						 else if(sp[1].equals("30"))
						 {
						    l6.setText(sp[0]);
							l8.setText("BDT "+sp[2]+"tk");
							
						 }
						  else if(sp[1].equals("31"))
						 {
						    l1.setText(sp[0]);
	...
	ThrillerFrame.add(p1);
		...
		//ThrillerFrame Properties
	     ThrillerFrame.setSize(1080, 650);
         ThrillerFrame.setLayout(null);
         ThrillerFrame.setLocationRelativeTo(null);
         ThrillerFrame.setVisible(true);
		 ThrillerFrame.setResizable(false);
         ThrillerFrame.setDefaultCloseOperation(EXIT_ON_CLOSE);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
        ThrillerFrame.setVisible(false);
		 new HomePage(login);
		}
